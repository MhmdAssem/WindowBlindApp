...
Public Class JobSheet
    ...
    Dim GridDataSet As DataSet, Deductiontable As DataTable, Fixing_Deduction As DataTable, GridTimerDataSet As DataSet, GridPageDataSet As DataSet, GridDataTabel As DataTable, strXMLDoc As String, strDedFilepath As String, strXLDoc As String, strXLFDoc As String, strCreatedXLDoc, StrPrinterName As String
        ...
        Try
            ...
            Try
                If WB_Ded IsNot Nothing Then
                    ...
                    sheet2 = WB_Ded.GetSheetAt(1)

                    Fixing_Deduction = GetDSFromSheet(sheet2, 0, 10, 20, "DEDUCTION")
                            ...
                            For i = 0 To (drarray.Length - 1)
                                Try
                                    ...
                                    If drarray(i)("Bind. Type/# Panels/Rope/Operation").ToString.Trim = "SPRING" Or drarray(i)("Bind. Type/# Panels/Rope/Operation").ToString.Trim = "SPRINGHD" Then
                                        ...
                                        DR("Cut Width") = GetCutwidth(drarray(i)("Width").ToString.Trim, drarray(i)("Bind. Type/# Panels/Rope/Operation").ToString.Trim, drarray(i)("Fixing Type / Bracket Type").ToString.Trim).Trim()
                                    Else
                                        DR("Spring") = "NO"
                                        DR("Cut Width") = GetCutwidth(drarray(i)("Width").ToString.Trim, drarray(i)("Bind. Type/# Panels/Rope/Operation").ToString.Trim, drarray(i)("Fixing Type / Bracket Type").ToString.Trim).Trim
    ...
    Protected Function GetCutwidth(ByVal width As String, ByVal value As String, ByVal fixing As String) As String
        ...
        If fixing.Trim = String.Empty Then
            fixing = "BLANK"
        End If

        DR = Deductiontable.Select("OperationType='" + value.Trim + "'")
        If Fixing_Deduction.Rows.Count > 0 Then
            DR2 = Fixing_Deduction.Select("FixingType='" + fixing.Trim + "'")
        End If
        ...
        If DR.Length > 0 Then
            If Not DR2 Is Nothing Then
                If DR2.Length > 0 Then
                    cutwidth = (Convert.ToDouble(TranslateNumber(width)) - DR(0)("Deduction").ToString() - DR2(0)("Deduction").ToString())
                End If
